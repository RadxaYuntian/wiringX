...
static struct layout_t {
	...
	{"XGPIOA_14", 0, 494, {0x1c, 0x3}, {GPIO_SWPORTA_DDR, 14}, {GPIO_SWPORTA_DR, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP14 */
	{"XGPIOA_15", 0, 495, {0x20, 0x3}, {GPIO_SWPORTA_DDR, 15}, {GPIO_SWPORTA_DR, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP15 */
	{"XGPIOA_16", 0, 496, {0x24, 0x3}, {GPIO_SWPORTA_DDR, 16}, {GPIO_SWPORTA_DR, 16}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP12 */
	{"XGPIOA_17", 0, 497, {0x28, 0x3}, {GPIO_SWPORTA_DDR, 17}, {GPIO_SWPORTA_DR, 17}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP13 */
	{"XGPIOA_22", 0, 502, {0x30, 0x3}, {GPIO_SWPORTA_DDR, 22}, {GPIO_SWPORTA_DR, 22}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP18 */
	{"XGPIOA_23", 0, 503, {0x3c, 0x3}, {GPIO_SWPORTA_DDR, 23}, {GPIO_SWPORTA_DR, 23}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP16 */
	{"XGPIOA_24", 0, 504, {0x40, 0x3}, {GPIO_SWPORTA_DDR, 24}, {GPIO_SWPORTA_DR, 24}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP17 */
	{"XGPIOA_25", 0, 505, {0x34, 0x3}, {GPIO_SWPORTA_DDR, 25}, {GPIO_SWPORTA_DR, 25}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP19 */
	{"XGPIOA_26", 0, 506, {0x2c, 0x3}, {GPIO_SWPORTA_DDR, 26}, {GPIO_SWPORTA_DR, 26}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP21 */
	{"XGPIOA_27", 0, 507, {0x38, 0x3}, {GPIO_SWPORTA_DDR, 27}, {GPIO_SWPORTA_DR, 27}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP20 */
	{"XGPIOA_28", 0, 508, {0x4c, 0x3}, {GPIO_SWPORTA_DDR, 28}, {GPIO_SWPORTA_DR, 28}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP0  */
	{"XGPIOA_29", 0, 509, {0x50, 0x3}, {GPIO_SWPORTA_DDR, 29}, {GPIO_SWPORTA_DR, 29}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP1  */
	...
	{"XGPIOB_3", 1, 451, {0xa8, 0x3}, {GPIO_SWPORTA_DDR, 3},  {GPIO_SWPORTA_DR, 3},  FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP26 */
	{"XGPIOB_6", 1, 454, {0xac, 0x3}, {GPIO_SWPORTA_DDR, 6},  {GPIO_SWPORTA_DR, 6},  FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP27 */
	...
	{"XGPIOC_9", 2, 425, {0xf0, 0x3}, {GPIO_SWPORTA_DDR, 9},  {GPIO_SWPORTA_DR, 9},  FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP10 */
	{"XGPIOC_10", 2, 426, {0xf4, 0x3}, {GPIO_SWPORTA_DDR, 10}, {GPIO_SWPORTA_DR, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP11 */
	...
	{"XGPIOC_24", 2, 440, {0x12c, 0x3}, {GPIO_SWPORTA_DDR, 24}, {GPIO_SWPORTA_DR, 24}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP25 */
	...
	{"PWR_GPIO_4",  3, 356, {0x68, 0x3}, {GPIO_SWPORTA_DDR, 4},  {GPIO_SWPORTA_DR, 4},  FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP22 */
	...
	{"PWR_GPIO_18", 3, 370, {0x8c, 0x3}, {GPIO_SWPORTA_DDR, 18}, {GPIO_SWPORTA_DR, 18}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP9  */
	{"PWR_GPIO_19", 3, 371, {0x90, 0x3}, {GPIO_SWPORTA_DDR, 19}, {GPIO_SWPORTA_DR, 19}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP4  */
	{"PWR_GPIO_20", 3, 372, {0x94, 0x3}, {GPIO_SWPORTA_DDR, 20}, {GPIO_SWPORTA_DR, 20}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP5  */
	{"PWR_GPIO_21", 3, 373, {0x98, 0x3}, {GPIO_SWPORTA_DDR, 21}, {GPIO_SWPORTA_DR, 21}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP8  */
	{"PWR_GPIO_22", 3, 374, {0x9c, 0x3}, {GPIO_SWPORTA_DDR, 22}, {GPIO_SWPORTA_DR, 22}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP7  */
	{"PWR_GPIO_23", 3, 375, {0xa0, 0x3}, {GPIO_SWPORTA_DDR, 23}, {GPIO_SWPORTA_DR, 23}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP6  */
	{"PWR_GPIO_25", 3, 377, {0x88, 0x3}, {GPIO_SWPORTA_DDR, 25}, {GPIO_SWPORTA_DR, 25}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP3  */
	{"PWR_GPIO_26", 3, 378, {0x84, 0x3}, {GPIO_SWPORTA_DDR, 26}, {GPIO_SWPORTA_DR, 26}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, /* GP2  */
};
